...
it("offers only save or discard and waits for saving before leaving", async () => {
  let finish!: () => void;
  ...
  expect(within(dialog).getAllByRole("button").map((button) => button.textContent)).toEqual(["Discard changes", "Save changes"]);
