use crate::project::{ProjectConfig, reference_tokens::action_reference_ids};
use std::collections::BTreeSet;

pub(super) struct Effects { changed_shots: BTreeSet<String>, pub(super) defaults: crate::generation::models::SceneDefaults }
impl Effects {
    pub(super) fn new(defaults: crate::generation::models::SceneDefaults) -> Self { Self { changed_shots: BTreeSet::new(), defaults } }
    pub(super) fn shots_changed(&mut self, scene: &str) { self.changed_shots.insert(scene.to_string()); }
